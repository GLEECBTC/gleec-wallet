...
/// Wallets acknowledged this session, keyed by wallet name.
///
...
final Set<String> _acknowledgedThisSession = <String>{};
...
Future<bool> ensureSeedBackedUp(
  ...
  if (_acknowledgedThisSession.contains(wallet!.name)) return true;
        ...
        builder: (context, state) {
          switch (state.step) {
            case SecuritySettingsStep.seedShow:
              ...
              return SeedShow(seedPhrase: _seed, privKeys: const {});
            ...
            default:
              return const Center(
                child: Padding(padding: EdgeInsets.all(32), child: UiSpinner()),
              );
          }
        },
      ),
