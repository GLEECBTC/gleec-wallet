...
class Matches {
  ...
  factory Matches.fromJson(Map<String, dynamic> json) => Matches(
    connect: json['connect'] == null
        ? null
        : MatchConnect.fromJson(orderStringMap(json['connect'], 'connect')),
    connected: json['connected'] == null
        ? null
        : MatchConnect.fromJson(orderStringMap(json['connected'], 'connected')),
    lastUpdated: orderNonNegativeInt(json['last_updated'] ?? 0, 'last_updated'),
    request: json['request'] == null
        ? null
        : MatchRequest.fromJson(orderStringMap(json['request'], 'request')),
    reserved: json['reserved'] == null
        ? null
        : MatchRequest.fromJson(orderStringMap(json['reserved'], 'reserved')),
  );

  final MatchConnect? connect;
  final MatchConnect? connected;
  final int lastUpdated;
  final MatchRequest? request;
  final MatchRequest? reserved;
