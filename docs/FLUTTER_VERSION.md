...
This project supports Flutter `3.41.7`. We aim to keep the project up-to-date with the most recent stable Flutter versions.
...
- Known issues with `flutter pub get` when using Flutter 3.41.7
